...
# Loading the pretrained k-NN model and scaler
loaded_model = joblib.load('./models/knn_model.sav')  # Update the model filename to match your k-NN model
...
def main():
    ...
    if uploaded_file is not None:
        ...
        if landmarks:
            ...
            # Predict using the loaded k-NN model
            ...
            if prediction[0] in ['tree', 'goddess']:
