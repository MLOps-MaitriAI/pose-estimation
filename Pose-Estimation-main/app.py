...
# Set up Dagshub and MLflow configuration
...
def main():
    ...
    if uploaded_file is not None:
        ...
        with mlflow.start_run():
            ...
            if landmarks:
                ...
                # Log prediction and parameters with MLflow
                mlflow.log_param("landmarks", landmarks)
    ...
    if use_webcam:
        ...
        while cap.isOpened():
            ...
            # Start an MLflow run for real-time predictions
            with mlflow.start_run():
                ...
                if landmarks:
                    ...
                    # Log real-time prediction with MLflow
                    mlflow.log_param("landmarks", landmarks)
                    mlflow.log_param("prediction", prediction[0])
