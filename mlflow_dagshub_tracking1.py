...
X = data.iloc[:, :-1]  # All columns exc                                                        ept the last one
...
with mlflow.start_run(run_name="Pose_Estimation_Run"):
    ...
    mlflow.log_param("n_neighbors", clf.n_neighbors)  # Log the k parameter
    ...
    mlflow.sklearn.log_model(loaded_model, "pose_estimation_knn_model")
